...
process kmerid {
    ...
    script:
    """     
    python /opt/kmerid-master/kmerid_python3.py -f /home/$USER/WGS_Data/$dir/${sample_id}_R1.fastq.gz  -c /opt/kmerid-master/config/config.cnf -n > ${sample_id}_R1.tsv
   > ${sample_id}_4.txt 
    """
}
...
process srst2 {
   publishDir "/home/$USER/WGS_Results/$dir/${sample_id}/srst2", mode: 'copy'
    ...
    python /home/$USER/srst2/srst2/scripts/srst2.py  --input_pe ${sample_id}_R1.fastq.gz ${sample_id}_R2.fastq.gz --forward _R1 --reverse _R2 --output /home/$USER/WGS_Results/$dir/${sample_id}/srst2/ --log --gene_db /opt/VaccineDifferentiation/allVacDB9d_clustered.fasta
    > ${sample_id}_8.txt    
    else 
    > ${sample_id}_8.txt
    fi
