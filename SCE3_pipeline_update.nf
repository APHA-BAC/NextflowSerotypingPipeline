...
process srst2 {
   publishDir "/home/$USER/WGS_Results/$dir/${sample_id}/srst2", mode: 'copy'
    ...
    srst2  --input_pe ${sample_id}_R1.fastq.gz ${sample_id}_R2.fastq.gz --forward _R1 --reverse _R2 --output /home/$USER/WGS_Results/$dir/${sample_id}/srst2/ --log --gene_db /opt/srst2/VaccineDifferentiation/allVacDB9d_clustered.fasta
    > ${sample_id}_8.txt    
    else 
    > ${sample_id}_8.txt
    fi
