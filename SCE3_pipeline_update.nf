...
process kmerid {
    ...
    script:
    """     
    python /opt/kmerid/kmerid_python3.py -f /home/$USER/WGS_Data/$dir/${sample_id}_R1.fastq.gz  -c /opt/kmerid/config/config.cnf -n > ${sample_id}_R1.tsv
   > ${sample_id}_4.txt 
    """
}
...
process most {
   publishDir "/home/$USER/WGS_Results/$dir/${sample_id}/MOST", mode: 'copy'
    ...
    script:
    """     
    python /opt/most/MOST-master/MOST.py -1 /home/$USER/WGS_Data/$dir/${sample_id}_R1.fastq.gz  -2 /home/$USER/WGS_Data/$dir/${sample_id}_R2.fastq.gz -st /opt/most/MOST-master/MLST_data/salmonella --output_directory /home/$USER/WGS_Results/$dir/${sample_id}/MOST -serotype True --bowtie /opt/most/bowtie2-2.1.0/bowtie2 --samtools /opt/most/samtools-0.1.18/samtools
...
process srst2 {
   publishDir "/home/$USER/WGS_Results/$dir/${sample_id}/srst2", mode: 'copy'
    ...
    srst2.py  --input_pe ${sample_id}_R1.fastq.gz ${sample_id}_R2.fastq.gz --forward _R1 --reverse _R2 --output /home/$USER/WGS_Results/$dir/${sample_id}/srst2/ --log --gene_db /opt/srst2/VaccineDifferentiation/allVacDB9h1_clustered.fasta
    > ${sample_id}_8.txt    
    else 
    > ${sample_id}_8.txt
    fi
