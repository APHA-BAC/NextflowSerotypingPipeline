...
def apply_rules(limsSerotypes, limsSerogroup, limsSubgenus, row):
    ...
    # This is duplicate code; remove one or the other at some point
        ...
        limsStatus = "CheckRequired: this passes"
    ...
    # Random kedogou rule; should check this properly
    ...
    # RULE 12 ASSEMBLY SIZE LOWER
        ...
        limsStatus = "Inconclusive"
    # NEW RULE 12
    elif limsSubgenus == 'I' and salmPercent > 75 and sseJ == 'Java':
        if consensus ==  '1-I 1,4,[5],12:b:---1-I 4:b:---1-Paratyphi' or consensus == '1-Paratyphi--1-I 1,4,[5],12:b:---1-I 4:b:-':
